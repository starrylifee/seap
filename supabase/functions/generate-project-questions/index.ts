...
const questionTemplates: Record<string, QuestionTemplate[]> = {
  'I-1-1-1': [ // 비전 공유
    { indicatorId: 'I-1-1-1', respondentType: 'teacher', questionText: '구성원 합의로 학교 비전을 도출하고 공유했는가?', questionType: 'rating', orderIndex: 1, sectionName: '학교 운영' },
  ...
  'I-1-1-2': [ // 민주적 운영
    { indicatorId: 'I-1-1-2', respondentType: 'teacher', questionText: '교직원 회의가 민주적 토론 중심으로 운영되는가?', questionType: 'rating', orderIndex: 2, sectionName: '학교 운영' },
  ...
  'I-1-2-1': [ // 업무 경감
    { indicatorId: 'I-1-2-1', respondentType: 'teacher', questionText: '행정업무 전담팀 운영 등으로 수업 전념 여건이 조성되었는가?', questionType: 'rating', orderIndex: 3, sectionName: '학교 운영' },
    { indicatorId: 'I-1-2-1', respondentType: 'staff', questionText: '업무 분장이 합리적이고 효율적인가?', questionType: 'rating', orderIndex: 3 },
  ],
  'II-2-1-1': [ // 학생 맞춤형
    { indicatorId: 'II-2-1-1', respondentType: 'teacher', questionText: '학생 수준/흥미를 고려해 교육과정을 재구성했는가?', questionType: 'rating', orderIndex: 4, sectionName: '교육과정' },
  ...
  'II-2-1-2': [ // 진로 교육
    { indicatorId: 'II-2-1-2', respondentType: 'teacher', questionText: '체험 중심의 진로교육이 내실 있게 운영되었는가?', questionType: 'rating', orderIndex: 5, sectionName: '교육과정' },
  ...
  'II-2-2-1': [ // 교원 연수
    { indicatorId: 'II-2-2-1', respondentType: 'teacher', questionText: '전문성 신장을 위한 연수/공동체 활동이 활발한가?', questionType: 'rating', orderIndex: 6, sectionName: '인사/예산' },
  ...
  'III-3-1-1': [ // 기초학력
    { indicatorId: 'III-3-1-1', respondentType: 'teacher', questionText: '학습부진 학생을 위한 맞춤형 지도를 했는가?', questionType: 'rating', orderIndex: 7, sectionName: '교육성과' },
  ...
  'III-3-2-1': [ // 학교폭력
    { indicatorId: 'III-3-2-1', respondentType: 'teacher', questionText: '학교폭력 예방 교육 및 사안 처리가 적절한가?', questionType: 'rating', orderIndex: 8, sectionName: '교육성과' },
  ...
  'III-3-4-1': [ // 시설/급식
    { indicatorId: 'III-3-4-1', respondentType: 'teacher', questionText: '교육활동 공간이 청결하고 안전하게 관리되는가?', questionType: 'rating', orderIndex: 9, sectionName: '교육성과' },
      ...
      if (templates) {
        templates.forEach(template => {
          questionsToInsert.push({
            ...
            section_name: template.sectionName || null,
            is_required: true,
          })
        })
      }
